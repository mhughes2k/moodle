...
*/
    public static function get_enabled_plugins() {
        ...
        $enabled = array();
        foreach (explode(',', $CFG->groupng_plugins_enabled) as $groupngplugin) {
            $enabled[$groupngplugin] = $groupngplugin;
        }
    ...
    public static function enable_plugin(string $pluginname, int $enabled): bool {
        ...
        if (!empty($CFG->groupng_plugins_enabled)) {
            $plugins = array_flip(explode(',', $CFG->groupng_plugins_enabled));
        }
        ...
        if ($haschanged) {
            ...
            add_to_config_log('groupng_plugins_enabled', !$enabled, $enabled, $pluginname);
            set_config('groupng_plugins_enabled', $new);
            // Reset caches.
    ...
    public function get_settings_section_name() {
        if (file_exists($this->full_path('settings.php'))) {
            return 'groupngsettings' . $this->name;
        } else {
            return null;
        }
    }
    ...
    public function load_settings(part_of_admin_tree $adminroot, $parentnodename, $hassiteconfig) {
        ...
        $groupng = $this;      // Also can be used inside settings.php.
