...
privatefiles,moodle|/user/files.php';
    ...
    if ($oldversion < 2022030300.01) {
        ...
        // Define table groupng to be created.
        $table = new xmldb_table('groupng');

        // Adding fields to table groupng.
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('groupng', XMLDB_TYPE_CHAR, '20', null, XMLDB_NOTNULL, null, null);
        ...
        // Adding keys to table groupng.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id']);
        $table->add_key('courseid', XMLDB_KEY_FOREIGN, ['courseid'], 'course', ['id']);

        // Adding indexes to table groupng.
        $table->add_index('groupng', XMLDB_INDEX_NOTUNIQUE, ['groupng']);

        // Conditionally launch create table for groupng.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }
