...
switch ($action) {
    ...
    case 'deletegroup':
        ...
        redirect(new moodle_url('/groupng/delete.php', array('courseid'=>$courseid, 'groups'=>$groupidlist)));
        break;

    case 'showcreateorphangroupform':
        redirect(new moodle_url('/groupng/group.php', array('courseid'=>$courseid)));
        break;

    case 'showautocreategroupsform':
        redirect(new moodle_url('/groupng/autogroup.php', array('id'=>$courseid)));
        break;

    case 'showimportgroups':
        redirect(new moodle_url('/groupng/import.php', array('id'=>$courseid)));
        break;

    case 'showgroupsettingsform':
        redirect(new moodle_url('/groupng/group.php', array('courseid'=>$courseid, 'id'=>$groupids[0])));
        break;
    ...
    case 'showaddmembersform':
        redirect(new moodle_url('/groupng/members.php', array('group'=>$groupids[0])));
        break;
...
$renderable = new \core_group\output\index_page($courseid, $groupoptions, $selectedname, $members, $disableaddedit, $disabledelete,
    $preventgroupremoval);
$output = $PAGE->get_renderer('core_groupng');
