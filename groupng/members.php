...
$PAGE->set_url('/groupng/members.php', array('group'=>$groupid));
...
$returnurl = $CFG->wwwroot.'/groupng/index.php?id='.$course->id.'&group='.$group->id;
...
$PAGE->requires->js('/groupng/clientlib.js');
$PAGE->navbar->add($strparticipants, new moodle_url('/user/index.php', array('id'=>$course->id)));
$PAGE->navbar->add($strgroups, new moodle_url('/groupng/index.php', array('id'=>$course->id)));
...
<div id="addmembersform">
    <form id="assignform" method="post" action="<?php echo $CFG->wwwroot; ?>/groupng/members.php?group=<?php echo $groupid; ?>">
    <div>
