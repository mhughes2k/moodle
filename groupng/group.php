...
if ($id !== 0) {
    $PAGE->set_url('/groupng/group.php', array('id'=>$id));
} else {
    $PAGE->set_url('/groupng/group.php', array('courseid'=>$courseid));
}
...
navigation_node::override_active_url(new moodle_url('/groupng/index.php', array('id' => $course->id)));

$returnurl = $CFG->wwwroot.'/groupng/index.php?id='.$course->id.'&group='.$id;
...
$PAGE->navbar->add($strgroups, new moodle_url('/groupng/index.php', array('id'=>$courseid)));
